...
menu_wallpaper = pygame.image.load("menu new.png")
menu_new = pygame.image.load("menu ikon1.png")
menu_continue = pygame.image.load("menu ikon2.png")
menu_settings = pygame.image.load("menu ikon3.png")
menu_about = pygame.image.load("menu ikon4.png")
menu_quit = pygame.image.load("menu ikon5.png")
quit_img = pygame.image.load("quit.png")
quit_yes = pygame.image.load("quit ikon yes.png")
quit_no = pygame.image.load("quit ikon no.png")
about1 = pygame.image.load("about 1.png")
about2 = pygame.image.load("about 2.png")
about3 = pygame.image.load("about 3.png")
about1_menu = pygame.image.load("about choice 1.png")
about1_next = pygame.image.load("about choice 2.png")
about2_menu = pygame.image.load("about choice 3.png")
about2_back = pygame.image.load("about choice 4.png")
about2_next = pygame.image.load("about choice 5.png")
about3_menu = pygame.image.load("about choice 6.png")
about3_back = pygame.image.load("about choice 7.png")
settings_stmt = pygame.image.load("settings new1.png")
settings_stmf = pygame.image.load("settings new2.png")
settings_sfmf = pygame.image.load("settings new3.png")
settings_sfmt = pygame.image.load("settings new4.png")
settings_back = pygame.image.load("settings new5.png")
dis = pygame.image.load("frame for job.png")
intro1 = pygame.image.load("intro_1.png")
intro2 = pygame.image.load("intro_2.png")
intro3 = pygame.image.load("intro_3.png")
flag=0
#doc = pygame.image.load("doctor.png")

intros = [pygame.image.load("1.png"), pygame.image.load("2.png"), pygame.image.load("3.png"), pygame.image.load("4.png"),
          pygame.image.load("5.png"), pygame.image.load("6.png"), pygame.image.load("7.png"), pygame.image.load("8.png"), pygame.image.load("9.png"),
          pygame.image.load("10.png"), pygame.image.load("11.png"), pygame.image.load("12.png"), pygame.image.load("13.png"), pygame.image.load("14.png"),
          pygame.image.load("15.png"), pygame.image.load("16.png"), pygame.image.load("17.png")]
char = pygame.image.load("1234.png")
char_bright = pygame.image.load("123.png")
