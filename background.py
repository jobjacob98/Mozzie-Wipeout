...
#loading room
img_room=pygame.image.load("images/background.png").convert_alpha()
img_room=pygame.transform.scale(img_room,(800,600))

img_room2=pygame.image.load("images/back2.png").convert_alpha()
img_room2=pygame.transform.scale(img_room2,(800,600))

stag=pygame.image.load("images/pond.png").convert_alpha()
#Shop images
